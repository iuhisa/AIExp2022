...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--A_dataroot', required=True, help='path to images (should have subfolders: images, and files: train.txt, test.txt)')
        parser.add_argument('--B_dataroot', required=True, help='path to images (should have subfolders: images, and files: train.txt, test.txt)')
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='cycle_gan', help='chooses which model to use. [cycle_gan | recycle_gan]')
        ...
        # parser.add_argument('--act', type=str, default='leakyrelu', help='activation function [leakyrelu | tanhexp]')
        ...
        parser.add_argument('--load_size', type=int, default=158, help='scale images to this size')
        ...
        parser.add_argument('--batch_multiplier', type=int, default=1, help='the interval per minibatch to optimize params. see Multiple Minibatch.')
